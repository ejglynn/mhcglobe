...
class BuildModel():
    ...
    def build_graph(self, hparams):
        ...
        input_peptide_tnsr = Input(shape=(pep_len, aa_rep_len), name='peptide_input', dtype='float32')
        input_mhc_tnsr = Input(shape=(mhc_len, aa_rep_len), name='mhc_input', dtype='float32')
